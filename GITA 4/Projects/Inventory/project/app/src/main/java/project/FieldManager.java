...
public class FieldManager extends JFrame implements ActionListener{
    ...
    private final FieldLabel[] fields = {itemField, priceField, quantityField};
    
    //text areas
    private final TextArea outputArea = new TextArea("", 20, 40);
    ...
    public void addProducts(){
        inventory.addNewProduct("hammer", 15.95, 100);
        inventory.addNewProduct("saw", 24.50, 15);
        inventory.addNewProduct("drill", 139.75, 25);
        inventory.addNewProduct("vise", 87.65, 10);
    }
    ...
    public void action(){
        ...
        inventory.addNewProduct(item, price, quantity);
